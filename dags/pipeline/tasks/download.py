...
def download_from_s3(bucket: str, key: str, destDir: str, destFile: str):
...
def _download_callable(params):
    ...
    destDir = os.path.join(WORK_DIR, "zip")
    destFile = os.path.join(destDir, key)
    download_from_s3(bucket, key, destDir, destFile)
